...
class LoginActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ib_clickhere_login.setOnClickListener(this)
        ib_login.setOnClickListener(this)
        ib_register_login.setOnClickListener(this)
    }

    override fun onClick(v: View) {
        when(v.id){
            R.id.ib_clickhere_login -> startActivity(
                ForgotActivity.getLaunchService(
                    this
                )
            )
            R.id.ib_register_login -> startActivity(
                RegisterActivity.getLaunchService(
                    this
                )
            )
            R.id.ib_login -> LoginEmailPass()
        }
    }
